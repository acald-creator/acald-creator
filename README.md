...
**Technologies and/or Stack:**
- Golang, F#, Haskell, Scala, Rust, Typescript
- AWS, Azure, GCP, Oracle, DigitalOcean, Linode
- Kubernetes, Docker, LXD/LXC, Vagrant, Packer, Istio, HashiCorp Consul
- HashiCorp Vault, AWS KMS, Azure Vault
- Terraform, cdktf, cdk8s, Pulumi, AWS CDK, AWS CloudFormation
- Serverless, Serverless Stack (SST), Knative, Fn, OpenFaas
- tfsec, falco, docker-bench, kube-bench, semgrep, trivy, dagger, opa, cosign, fulcio, rekor
...
**Projects**
- Writeups for HackTheBox at https://acaldwell.dev
...
I’m looking to collaborate on projects that are bleeding edge technologies. Reach out to me and let me know!
